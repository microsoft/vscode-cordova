...
export enum InternalErrorCode {
    ...
    // NotInCordovaFolderError = 604,
    // CouldNotFindProjectVersion = 605,
    // CordovaPackageIsNotInstalled = 606,
    // CordovaWindowsIsNotInstalled = 607,
    // CordovamacOSIsNotInstalled = 608,
    ...
    // ReconnectionToPackagerFailedCheckForErrorsOrRestartCordova = 1403,
    // FailedToProcessMessageFromCordovaApp = 1404,
    // FailedToPrepareJSRuntimeEnvironment = 1405,
    // FailedToSendMessageToTheCordovaApp = 1406,
    // CordovaWorkerProcessThrownAnError = 1407,
