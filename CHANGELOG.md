...
* Refactored Command Palette commands for Ionic applications (`Ionic: Build`, `Ionic: Run` and `Ionic: Prepare`) to adapt them for the new Ionic commands syntax [#698](https://github.com/microsoft/vscode-cordova/pull/698)
* Implemented Android emulator selection when start debug scenarious [#699](https://github.com/microsoft/vscode-cordova/pull/699)
